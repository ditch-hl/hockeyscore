...
while True:
    ...
    game_time = time_font.render(game.get_time_readout(), False, (255, 0, 0))
    ...
    home_score_surf = count_font.render("12", False, (255, 0, 0))
    ...
    visitor_score_surf = count_font.render("09", False, (255, 0, 0))
    ...
    period_surf = count_font.render("2", False, (255, 0, 0))
